...
CREATE PROCEDURE add_customer(_customer_id INTEGER, _first_name VARCHAR, _last_name VARCHAR, _email VARCHAR, _phone_number VARCHAR)
LANGUAGE plpgsql 
AS $$
BEGIN
...
END
$$;
CALL add_customer(50, 'Bruce', 'Wayne', 'bruce.wayne@batman.com', '(472)026-3456');
